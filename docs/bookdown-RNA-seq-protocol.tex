...
\NormalTok{  x <-}
\StringTok{    }\KeywordTok{paste0}\NormalTok{(}\KeywordTok{with}\NormalTok{(fit.contr}\OperatorTok{$}\NormalTok{genes, Symbol[EntrezID }\OperatorTok{%in%}\StringTok{ }\NormalTok{xx]), }\DataTypeTok{collapse =} \StringTok{"|"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{index<-}\KeywordTok{rownames}\NormalTok{(fit.contr) }\OperatorTok{%in%}\StringTok{ }\NormalTok{go.all[[}\KeywordTok{rownames}\NormalTok{(fry.GSEA)[}\DecValTok{1}\NormalTok{]]]}
